...
// Fetch all events where the user has been invited (has an RSVP record)
$stmt = $conn->prepare("
    SELECT 
        e.event_id,
        e.event_name,
...
// Handle RSVP updates via AJAX - NEED A DIFFERENT WAY TO HANDLE THIS - have we discussed ajax in class??
